...
export default function DemoDataPage() {
  ...
  return (
    <div className="p-5 max-w-2xl">
      ...
      <p className="text-[12.5px] text-[#231714]/50 mt-1 leading-relaxed">
      ...
      {loading ? (
        <div className="mt-6 text-sm text-[#231714]/40">読み込み中...</div>
      ) : seasons.length === 0 ? (
        <div className="mt-6 rounded-xl border border-gray-100 bg-white p-6 text-center text-sm text-[#231714]/50">
          先に「シーズン」タブで麻雀シーズンを作成してください。
        </div>
      ) : (
        <div className="mt-5 space-y-5">
          <div>
            <label className="block text-[11px] font-extrabold text-[#231714]/50 tracking-wide mb-1.5">
              対象シーズン
            </label>
            <select
              value={seasonId}
          ...
          <div className="rounded-xl bg-[#f7f8f8] p-3.5 text-[12px] text-[#231714]/55 leading-relaxed">
            ...
            <ul className="mt-1 list-disc pl-4 space-y-0.5">
              ...
              <li>当日の参加7名（支払い済み・先着8名の残り1枠は空き＝ゲスト/スタッフで参加・支払いを試せます）</li>
              <li>当日の卓（demoユーザーを含む＝申告タブの確認用）</li>
            </ul>
          </div>
        </div>
      )}
