        ...
        {(emailSent || guestUrl) ? (
          <>
            ...
            <div className="flex gap-2">
              {guestUrl && (
                <button
                  onClick={async () => { await navigator.clipboard.writeText(guestUrl); setCopied(true); setTimeout(() => setCopied(false), 2000); }}
              ...
              <button
                ...
                className={`${guestUrl ? "px-4" : "flex-1"} py-2.5 text-sm border border-[#231714]/10 rounded-xl text-[#231714]/80 hover:bg-[#231714]/5 transition-colors`}
              >
                閉じる
              </button>
            </div>
