...
function InfoRow({ label, value }: { label: string; value: string | null | undefined }) {
  return (
    <div className="flex items-start py-2.5 border-b border-[#231714]/5 last:border-b-0">
      <span className="text-xs text-[#231714]/80 w-28 shrink-0 pt-0.5">{label}</span>
    ...
    <div className="fixed inset-0 bg-black/40 flex items-start justify-end z-50">
      ...
      <div className="relative bg-white h-full w-full max-w-xl overflow-y-auto shadow-2xl animate-slideIn">
        ...
        <div className="bg-gradient-to-br from-[#A5C1C8]/30 to-[#A5C1C8]/10 px-6 pt-6 pb-5">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 pt-1">
              ...
              <p className="text-sm text-[#231714]/80 mt-1">{[companyName, jobTitle].filter(Boolean).join(" / ") || user.tenantName || "—"}</p>
              ...
              <div className="flex items-center gap-2 mt-3">
                ...
                {user.lineUserId ? (
                  ...
                  <span className="inline-flex items-center px-2 py-0.5 bg-[#231714]/5 text-[#231714]/80 text-xs rounded-full">
                    LINE未連携
                  </span>
                )}
                {user.profileComplete ? (
                  <span className="inline-flex items-center px-2 py-0.5 bg-[#A5C1C8]/25 text-[#231714]/80 text-xs rounded-full">
                    プロフィール登録済み
                  </span>
                ) : (
        ...
        <div className="px-6 py-5 space-y-5">
          {/* 連絡先情報 */}
          <section>
            <h3 className="text-xs font-semibold text-[#231714]/80 uppercase tracking-wider mb-2 flex items-center gap-2">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
          ...
          <div className="pt-3">
            <p className="text-xs font-bold text-[#231714]/85 mb-1.5">区分</p>
          ...
          <div className="pt-4 border-t border-[#231714]/5">
            ...
            <p className="text-xs text-[#231714]/75 text-center mt-2">
