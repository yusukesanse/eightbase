...
export default function AdminNotificationsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      ...
      {loading ? (
        <div className="text-center py-12 text-sm text-gray-500">読み込み中...</div>
      ) : items.length === 0 ? (
        <div className="bg-gray-50 rounded-xl px-4 py-8 text-center text-sm text-gray-500">
          通知はありません
        </div>
      ) : (
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] text-gray-500">{fmt(n.createdAt)}</span>
                </div>
