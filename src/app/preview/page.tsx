    ...
    return (
      <div className="min-h-screen bg-[#FAF7F2] flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-2 text-xs text-[#231714]/85 text-center">
            チーム共有用のUIプレビューモードです。
            <br />
            アクセストークンを入力してください。
          </p>
          ...
          <p className="mt-6 text-[10px] text-[#231714]/75 text-center">
            閲覧専用のプレビューモードです。
          </p>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#FAF7F2]">
      <div className="max-w-2xl mx-auto p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={deactivate}
            className="px-3 py-1.5 text-xs text-[#231714]/85 border border-[#231714]/10 rounded-lg hover:bg-white"
          >
            終了
          </button>
        </div>
        ...
        <p className="mt-8 text-[10px] text-[#231714]/75 text-center">
  ...
  return (
    ...
    >
      <div>
        ...
        <div className="text-[11px] text-[#231714]/80 mt-0.5">{desc}</div>
      </div>
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="shrink-0 text-[#231714]/75">
  ...
  return (
    ...
    >
      <div>
        ...
        <div className="text-[11px] text-[#231714]/80 mt-0.5 ml-7">{desc}</div>
      </div>
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="shrink-0 text-[#231714]/75">
        <path d="M6 4l4 4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
