      ...
      {([1, -1] as const).map((s) => {
        ...
        return (
          <button
            ...
            style={active ? { background: accent, color: "#fff" } : { background: "#f6f8f9", color: "#6b6e73" }}
          >
            {s === 1 ? "＋" : "−"}
          </button>
        );
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-[10.5px] font-bold" style={{ color: me ? "#6b6e73" : "rgba(255,255,255,.92)" }}>
      ...
      {done && (
        <div className="flex items-baseline justify-between mt-2">
          ...
          <span className="text-[11px] font-extrabold" style={{ color: me ? "#6b6e73" : "rgba(255,255,255,.95)" }}>{m.rank}着</span>
        </div>
      )}
    </div>
  );
