...
export function LeaguePyramid({
  ...
  return (
    <div className="space-y-5">
          ...
          return (
            <div key={`list-${t}`}>
              ...
              <div className="flex items-center gap-2 mx-0.5 mb-2">
                ...
                <span className="text-[11px] text-[#6b6e73]">{TIER_META[t].desc}</span>
                <span className="flex-1 h-px bg-[#eceff1]" />
                <span className="text-[11px] text-[#6b6e73]">{members.length}名</span>
              </div>
                    ...
                    >
                      <div className="w-[26px] text-center shrink-0">
                        <span
                          ...
                          style={{ fontSize: top3 ? 19 : 16, color: top3 ? col : "#6b6e73", letterSpacing: "-.03em" }}
                        >
                          {s.rank}
                        </span>
                      </div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex gap-2.5 mt-0.5 text-[11px] text-[#6b6e73] tabular-nums">
                      ...
                      <div className="text-right shrink-0 min-w-[64px]">
                        ...
                        <div className="text-[9.5px] font-bold text-[#6b6e73] mt-0.5">
                          {byTotal ? "合計点" : "AVG"}
                        </div>
                        <div className="text-[10px] text-[#6b6e73] tabular-nums mt-0.5">
                          {byTotal
      ...
      <p className="text-[11px] text-[#6b6e73] leading-relaxed px-1">
